...
(function() {
    ...
    var
        ...
        plugins = {
            ...
            owl: $(".owl-carousel"),
            preloader: $(".preloader"),
            rdNavbar: $(".recarc-navbar"),
            rdMailForm: $(".recarc-mailform"),
    ...
    $(function() {
        ...
        function attachFormValidator(elements) {
            ...
            elements.on('input change propertychange blur', function(e) {
                ...
                if ($this.parents('.recarc-mailform').hasClass('success')) return;
        ...
        if (plugins.rdNavbar.length) {
            ...
            plugins.rdNavbar.RDNavbar({
                ...
                callbacks: {
                    onStuck: function() {
                        var navbarSearch = this.$element.find('.recarc-search input');
                    ...
                    onUnstuck: function() {
                        ...
                        var navbarSearch = this.$clone.find('.recarc-search input');
